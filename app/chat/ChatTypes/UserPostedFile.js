...
export default class UserPostedFile extends Component {
  ...
  render () {
    let {userId, navigator, person, message, createdAt, profileImage} = this.props;
          ...
          <View style={{ flexDirection: 'row' }}>
            ...
            <View style={styles.recieverMessages}>
              <Text style={styles.recieverMessagesText}>
                Uploaded "{message.fileName}" Follow This Link To Download
                <Text style={styles.linkTextReciever}>{message.fileUrl}</Text>
              </Text>
            </View>
          </View>
        ...
        <View style={styles.container}>
          <View style={styles.senderMessages}>
            <Text style={styles.senderMessagesText}>
              Uploaded "{message.fileName}" Follow This Link To Download <Text style={styles.linkTextSender}>{message.fileUrl}</Text>
             </Text>
           </View>
