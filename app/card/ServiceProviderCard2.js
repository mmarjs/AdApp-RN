...
var ServiceProviderCard2 = React.createClass(
  {
    ...
    render() {
      ...
      let saveEmpty = <Icon name={'icon-save'} fontSize={25} color={'black'}/>;
      let saveFilled = <Icon name={'icon-save-filled'} fontSize={25} color={StyleConstants.primary}/>;
          ...
          <View style={styles.container}>
            <TouchableOpacity onPress={this.openDetailedCard}>
              ...
              <View style={{flexDirection:'row', justifyContent:'space-between'}}>
                ...
                <View style={{flex:1,justifyContent:'flex-end', flexDirection:'row', marginVertical: 3, marginRight:15}}>
              ...
              <View style={style.spNameLogo}>
                ...
                <Text style={[Style.textColorBlack, Style.f12]}>
                  {'Added ' + moment(this.props.addedAt).startOf('day').fromNow()}
                </Text>
              </View>
              ...
              <View style={[Style.rowWithSpaceBetween, {
                ...
                <View
                  style={[{justifyContent: 'center', alignSelf: 'center', flexDirection: 'row', marginRight: -22}]}>
                  ...
                  <TouchableOpacity style={[styles.favButtons]}
                    ...
                    <Icon name={'icon-Share'} fontSize={24} color={'black'}/>
                    <Text style={[styles.greyTextLight, {textAlign: 'left'}]}>
                      313
                    </Text>
                  </TouchableOpacity>
...
export default ServiceProviderCard2;
