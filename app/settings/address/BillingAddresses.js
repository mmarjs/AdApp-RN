...
let BillingAddresses = React.createClass({
  ...
  componentDidMount () {
    ...
    .then((value) => {
      ...
      return get(value, 'Users/Profile/Addresses/billing');
    })
    .then((value) => {
      // console.log(value);
      this.setState({
  ...
  onPressAdd () {
    this.props.navigator.push({ id: 131, type: 'BILLING_ADDRESS' , onUnmount: () => this.updateView()});
  },
  updateView() {
    AsyncStorage.getItem("UserToken")
      .then((value) => {
