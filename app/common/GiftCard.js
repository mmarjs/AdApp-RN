...
var GiftCard = React.createClass( 
{
	getInitialState()
	{
	...
	checkNumber()
	{
		console.log ("this.props.backScreen: "+ this.props.backScreen);
			...
			<View style = {styles.mainContainer}>
				...
				<View style={styles.borderStyle}>
					<View style = {styles.cardLogo}>
						<Image					
							source = {require('../../res/common/gift_redeeem_icon.png')}
						/>
					</View>
					...
					<View style={styles.inputFieldView}>
						<TextInput
							...
							placeholder  = 'Please enter your gift card code here'
